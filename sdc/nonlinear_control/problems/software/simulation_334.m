% Week 3: Concept check 3, Question 4
% 2022.03.4
...
for i = 1:length(time)-1
    ...
    u = control(I, omega, omega_rn, omega_dot_rn, sigma, sigma_rn, K, P, L);
...
fprintf("MRP attitude norm at %d secs: %f\n",...
    display_norm, norm(sigmas(:,display_norm/dt)));
fprintf("Steady state attitude at %d secs: ", display_norm);
disp(sigmas(:,display_norm/dt)');
...
u = -K * sigma_br - P * omega_br + cross(omega_bn, I * omega_bn) ...
    + I * (omega_dot_rn - cross(omega_bn, omega_rn)) - L;
end
